System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'sys', 'director', 'game']);
      ...
      _export("userMgr", userMgr = (_dec = ccclass('userMgr'), _dec(_class = (_class2 = class userMgr extends Component {
        ...
        getGameInfo(gamename) {
          for (var i = 0; i < globalThis.userMgr.serverMap.length; i++) {
...
//# sourceMappingURL=f1275100ee5ef33e720d0ab9985fa62c52b5b09a.js.map