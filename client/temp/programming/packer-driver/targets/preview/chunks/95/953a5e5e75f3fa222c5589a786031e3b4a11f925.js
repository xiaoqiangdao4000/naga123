            ...
            case 'accountLogin':
              {
                if (this.accountNode != null) {
                  console.log('this.accountNode存在 = ', this.accountNode);
                  this.node.addChild(this.accountNode);
                  break;
                }

                console.log('this.accountNode = ', this.accountNode);
                resources.load("prefab/login_account", Prefab, (err, prefab) => {
                  this.accountNode = instantiate(prefab);
                  this.node.addChild(this.accountNode);
                  console.log('prefab加载完毕 = ', this.node.children);
...
//# sourceMappingURL=953a5e5e75f3fa222c5589a786031e3b4a11f925.js.map