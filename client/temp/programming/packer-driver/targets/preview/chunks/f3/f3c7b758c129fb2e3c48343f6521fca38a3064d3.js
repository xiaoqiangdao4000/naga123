System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("game_jxlw", game_jxlw = (_dec = ccclass('game_jxlw'), _dec2 = property(SpriteFrame), _dec3 = property(SpriteFrame), _dec4 = property(Sprite), _dec5 = property(Sprite), _dec6 = property(Sprite), _dec7 = property(Sprite), _dec8 = property(Sprite), _dec9 = property(Sprite), _dec10 = property(Sprite), _dec11 = property(Sprite), _dec12 = property(Sprite), _dec13 = property(Sprite), _dec(_class = (_class2 = class game_jxlw extends Component {
        constructor() {
          super(...arguments);
        ...
        setBetScore(btn) {
          if (btn == 1) {
            if (this.bet_score[0] < 99) this.bet_score[0] += 1;
            this.setBetScoreEx(this.bet1_score_spr, this.bet_score[0]);
          }
        } //设置用户分数


        setBetScoreEx(betnode, score) {
          var str = score.toString();
          var len = str.length;
          ...
          for (var i = 0; i < 10; i++) {
            if (i < len) {
              var st = Number(str[len - i - 1]);
              betnode[i].spriteFrame = this.up_number_spf[st];
              betnode[i].node.active = true;
            } else {
              betnode[i].node.active = false;
            }
          }
        }
...
//# sourceMappingURL=f3c7b758c129fb2e3c48343f6521fca38a3064d3.js.map