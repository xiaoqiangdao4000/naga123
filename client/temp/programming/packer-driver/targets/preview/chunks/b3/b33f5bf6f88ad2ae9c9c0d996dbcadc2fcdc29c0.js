      ...
      _export("sgj_btn", sgj_btn = (_dec = ccclass('sgj_btn'), _dec2 = property({
        ...
        setBetScore(betn_node) {
          ...
          if (this.bet_score < 99 && globalThis.userMgr.score > 0) {
            ...
            (_crd && sgj_sprite === void 0 ? (_reportPossibleCrUseOfsgj_sprite({
              error: Error()
            }), sgj_sprite) : sgj_sprite).getInstance().setUserScore(globalThis.userMgr.score);
          } else {
            (_crd && sgj_sprite === void 0 ? (_reportPossibleCrUseOfsgj_sprite({
              error: Error()
            }), sgj_sprite) : sgj_sprite).getInstance().addTops('余额不足,请充值。。。');
          }
        }
...
//# sourceMappingURL=b33f5bf6f88ad2ae9c9c0d996dbcadc2fcdc29c0.js.map