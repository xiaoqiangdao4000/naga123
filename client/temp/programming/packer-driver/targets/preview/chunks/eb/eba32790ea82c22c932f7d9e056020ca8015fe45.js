System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, EventTarget, EditBox, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, bind_account_eventTarget, bind_account;
  ...
  return {
    ...
    execute: function () {
      ...
      bind_account_eventTarget = new EventTarget();
            ...
            case 'btn_ok':
              {
                if (this.nickname_editbox.string == '') {
                  console.log('投递 nickname '); //bind_account_eventTarget.emit('nickname', '用户名不能为空');

                  globalThis.eventTargets.emit('nickname', '用户名不能为空'); // if (globalThis.eventTarget == null) {
...
//# sourceMappingURL=eba32790ea82c22c932f7d9e056020ca8015fe45.js.map