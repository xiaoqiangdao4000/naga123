  ...
  return {
    ...
    execute: function () {
      ...
      _export("sgj_run", sgj_run = (_dec = ccclass('sgj_run'), _dec(_class = class sgj_run extends Component {
        ...
        updateMask() {
          //中奖结束回调
          var curIndex = Math.floor(this.startIndex) % 24 + 1; //console.log('当前格子 = ', curIndex);
          ...
          if (this.startIndex > 14 && this.startIndex < this.endIndex - 16 && this.sound2_time > 1) {
            ...
            if ((_crd && AudioMgr === void 0 ? (_reportPossibleCrUseOfAudioMgr({
              error: Error()
            }), AudioMgr) : AudioMgr).inst.isPlaying()) {
              console.log('正在播放中。。。。 = ', (_crd && AudioMgr === void 0 ? (_reportPossibleCrUseOfAudioMgr({
                error: Error()
              }), AudioMgr) : AudioMgr).inst.isPlaying());
            } else {
              (_crd && AudioMgr === void 0 ? (_reportPossibleCrUseOfAudioMgr({
                error: Error()
              }), AudioMgr) : AudioMgr).inst.playOneShot('sound/sgj/turnstep2'); //console.log('正在播放中。。。。 = ', AudioMgr.inst.isPlaying());
            }
          } else {
...
//# sourceMappingURL=57838e6c2a7aad1d12a1c44c3b58b9c35c07f8e2.js.map