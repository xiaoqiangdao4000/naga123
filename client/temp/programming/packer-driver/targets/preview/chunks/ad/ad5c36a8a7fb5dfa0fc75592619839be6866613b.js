      ...
      _export("userMgr", userMgr = (_dec = ccclass('userMgr'), _dec(_class = (_class2 = class userMgr extends Component {
        ...
        onGuest(data) {
          if (data.userid == 0) {
            ...
            console.log('serverMap ===', globalThis.userMgr.serverMap); // globalThis.userMgr.hallip = data.hallip;
...
//# sourceMappingURL=ad5c36a8a7fb5dfa0fc75592619839be6866613b.js.map