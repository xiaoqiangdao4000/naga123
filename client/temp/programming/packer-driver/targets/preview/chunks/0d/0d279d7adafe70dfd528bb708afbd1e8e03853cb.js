      ...
      _export("game_sgj", game_sgj = (_dec = ccclass('game_sgj'), _dec2 = property(SpriteFrame), _dec3 = property(SpriteFrame), _dec4 = property(Sprite), _dec5 = property(Sprite), _dec6 = property(Sprite), _dec7 = property(Sprite), _dec8 = property(Sprite), _dec9 = property(Sprite), _dec10 = property(Sprite), _dec11 = property(Sprite), _dec12 = property(Sprite), _dec13 = property(Sprite), _dec(_class = (_class2 = class game_sgj extends Component {
        ...
        restBetScore() {
          for (var i = 0; i < 8; i++) {
            this.bet_score[i] = 0;
            var node = null;
            if (i == 0) node = this.bet1_score_spr;else if (i == 1) node = this.bet2_score_spr;else if (i == 2) node = this.bet3_score_spr;else if (i == 3) node = this.bet4_score_spr;else if (i == 4) node = this.bet5_score_spr;else if (i == 5) node = this.bet6_score_spr;else if (i == 6) node = this.bet7_score_spr;else if (i == 7) node = this.bet8_score_spr;
            var str = this.bet_score[i].toString();
            var len = str.length;

            for (var _i = 0; _i < 2; _i++) {
              if (_i < len) {
                var st = Number(str[len - _i - 1]);
...
//# sourceMappingURL=0d279d7adafe70dfd528bb708afbd1e8e03853cb.js.map