          ...
          var onGet = function onGet(ret) {
            if (ret != 0) {
              for (var i = 0; i < ret.length; i++) {
                console.log('收到服务器发来的公告消息=', ret[i]);
                globalThis.userMgr.noticemsg.push(ret[i]);
              }
            } //     if (ret.errcode !== 0) {
            //         console.log(ret);
            //     }
            ...
            //         // globalThis.userMgr.noticemsg.push(ret.msg);
...
//# sourceMappingURL=e429930399686024e34d61d94782abdd265a787d.js.map