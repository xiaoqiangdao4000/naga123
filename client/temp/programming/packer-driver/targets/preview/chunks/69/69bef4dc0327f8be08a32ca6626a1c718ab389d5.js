      ...
      _export("sgj_run", sgj_run = (_dec = ccclass('sgj_run'), _dec(_class = class sgj_run extends Component {
        ...
        updateMask() {
          ...
          if (this.startIndex < 7) {
            this.startIndex = this.startIndex + 0.2;
          ...
          if (this.startIndex >= 7 && this.startIndex < this.endIndex - 7 && this.sound2_time > 1) {
            this.sound2_time = 0;
            (_crd && AudioMgr === void 0 ? (_reportPossibleCrUseOfAudioMgr({
              error: Error()
...
//# sourceMappingURL=69bef4dc0327f8be08a32ca6626a1c718ab389d5.js.map