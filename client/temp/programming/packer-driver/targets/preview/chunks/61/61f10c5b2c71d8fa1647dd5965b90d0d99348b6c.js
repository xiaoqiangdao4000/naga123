    ...
    execute: function () {
      ...
      _export("loading", loading = (_dec = ccclass('loading'), _dec2 = property(Sprite), _dec(_class = (_class2 = class loading extends Component {
        ...
        start() {
          ...
          this.node.setRotationFromEuler(this.ex, this.ey, this.ez); // tween(sprnode)
          // .by(1, { rotaton(): r })
          // .repeatForever()
          // .start()
        }
        ...
        update(deltaTime) {
          ...
          this.ey = this.ey + 1;
          this.ez = this.ez + 1;
          this.node.setRotationFromEuler(this.ex, this.ey, this.ez); // let quat1 = new Quat();
          // let r = sprnode.getRotation(quat1);
          // r.y += 0.002;
          // if (r.y > 2) {
          //     r.y = 0;
...
//# sourceMappingURL=61f10c5b2c71d8fa1647dd5965b90d0d99348b6c.js.map