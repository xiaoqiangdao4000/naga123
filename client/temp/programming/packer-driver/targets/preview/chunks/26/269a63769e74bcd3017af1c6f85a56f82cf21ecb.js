          ...
          if (this.bet_score < 99 && globalThis.userMgr.score > 0) {
            ...
            for (var i = 0; i < 2; i++) {
              if (i < len) {
                ...
                betn_node[i].spriteFrame = globalThis.sgj_sprite.up_number_spf[st];
            ...
            globalThis.sgj_sprite.setUserScore(globalThis.userMgr.score);
          } else {
            globalThis.sgj_sprite.addTops('余额不足,请充值。。。');
          }
        }
...
//# sourceMappingURL=269a63769e74bcd3017af1c6f85a56f82cf21ecb.js.map