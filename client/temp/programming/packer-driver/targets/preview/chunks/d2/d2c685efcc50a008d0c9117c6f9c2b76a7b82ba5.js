      ...
      _export("sgj_run", sgj_run = (_dec = ccclass('sgj_run'), _dec(_class = class sgj_run extends Component {
        ...
        updateMask() {
          ...
          if (this.startIndex < 7) {
            ...
            this.startIndex = this.startIndex + 1; //  AudioMgr.inst.playOneShot('sound/sgj/turnstep2');
          ...
          if (this.startIndex >= 7 && this.startIndex < this.endIndex - 7 && this.sound2_time > 1) {
            ...
            this.sound2_time = this.sound2_time + 0.2;
          }
        }
...
//# sourceMappingURL=d2c685efcc50a008d0c9117c6f9c2b76a7b82ba5.js.map