    ...
    execute: function () {
      ...
      _export("login", login = (_dec = ccclass('login'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class login extends Component {
        constructor() {
          ...
          _initializerDefineProperty(this, "tips_prefab", _descriptor2, this);
        ...
        writable: true,
        initializer: null
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "tips_prefab", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=8ad1c16e4838f4d4e5255389730b84ed49d6951c.js.map