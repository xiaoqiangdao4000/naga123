    ...
    execute: function () {
      ...
      _export("sgj_run", sgj_run = (_dec = ccclass('sgj_run'), _dec(_class = class sgj_run extends Component {
        ...
        updateMask() {
          ...
          if (this.startIndex > 14 && this.startIndex < this.endIndex - 14 && this.sound2_time > 1) {
            this.sound2_time = 0;
            (_crd && AudioMgr === void 0 ? (_reportPossibleCrUseOfAudioMgr({
              error: Error()
          ...
          if (this.startIndex > this.endIndex - 14 && this.sound3_time == false) {
...
//# sourceMappingURL=5ee284b9ae561c8c9717ceaff09489c3a0cadbe9.js.map