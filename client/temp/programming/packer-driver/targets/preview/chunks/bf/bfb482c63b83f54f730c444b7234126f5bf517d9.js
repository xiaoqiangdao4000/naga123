  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", HTTP = class HTTP {
        ...
        sendRequest1() {
          //访问地址
          var url = "http://127.0.0.1:3000/guest?nickname=123&name=321"; //新建Http

          var xhr = new XMLHttpRequest(); //接收数据
...
//# sourceMappingURL=bfb482c63b83f54f730c444b7234126f5bf517d9.js.map