    ...
    execute: function () {
      ...
      _export("default", sgj_data = class sgj_data {
        ...
        getStepData(randomStep, betscore) {
          var t_step = randomStep;
          var t_area = this.serverStepArea[t_step];
          if (t_area > 9) t_area -= 10;
          var t_times = this.times[randomRangeInt(0, 7)];
          var winscore = 0;
        ...
        getEndData(betscore) {
          var endData = this.cmd_s_gameEnd; //获取第一次中奖格子

          var t_step = randomRangeInt(0, 24);
          var data = this.getStepData(t_step, betscore);
          ...
          endData.eventid = 0;
          var t_area = data[1];
          var t_winscore = data[3];
          var allBetScore = this.getAllBetScore(betscore); //判断是否中奖--中奖类型：0-不中奖，1-普通中奖，lucky：2-灭灯，3-翻倍，4-大三元，5-小三元，6-大四喜，7-众横四海，8-仙女散花，9-天龙八部，10-九莲宝灯，11-大满贯
...
//# sourceMappingURL=cabfa6f557c8e918074324849ae0763883537d7a.js.map