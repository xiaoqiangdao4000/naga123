      ...
      _export("userMgr", userMgr = (_dec = ccclass('userMgr'), _dec(_class = (_class2 = class userMgr extends Component {
        ...
        onGuest(data) {
          if (data.userid == 0) {
            ...
            globalThis.userMgr.saveAccount(data.nickname, data.password); // let tdata = []
            ...
            console.log('serverMap ===', globalThis.userMgr.serverMap[0].name); // globalThis.userMgr.hallip = data.hallip;
...
//# sourceMappingURL=15315ae984398d688d6c90ae3ac42c4ebaf7ea08.js.map