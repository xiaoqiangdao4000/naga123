System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, EventTarget, Label, director, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, eventTarget, hall;
  ...
  return {
    ...
    execute: function () {
      ...
      eventTarget = new EventTarget(); // if (globalThis.eventTarget == null) {
      ...
      _export("hall", hall = (_dec = ccclass('hall'), _dec2 = property(Node), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec(_class = (_class2 = class hall extends Component {
        ...
        onEnable() {
          globalThis.eventTargets.on('nickname', this._sayHello, this);
        }

        onDisable() {
          globalThis.eventTargets.off('nickname', this._sayHello, this);
        }
...
//# sourceMappingURL=095218399c8326bf0f96c8f0d4f4077dabae56d9.js.map