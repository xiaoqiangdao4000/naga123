      ...
      _export("sgj_run", sgj_run = (_dec = ccclass('sgj_run'), _dec(_class = class sgj_run extends Component {
        ...
        updateMask() {
          ...
          if (this.startIndex < 14) {
            ...
            this.startIndex = this.startIndex + 0.8;
          } else {
            this.startIndex = this.startIndex + 0.5;
          } //音频控制2


          if (this.startIndex >= 14 && this.startIndex < this.endIndex - 12 && this.sound2_time > 1) {
            this.sound2_time = 0;
            (_crd && AudioMgr === void 0 ? (_reportPossibleCrUseOfAudioMgr({
              error: Error()
          ...
          if (this.startIndex >= this.endIndex - 12 && this.sound3_time == false) {
...
//# sourceMappingURL=3630e6e634960cec2256ad24d1b0c466f88e2474.js.map