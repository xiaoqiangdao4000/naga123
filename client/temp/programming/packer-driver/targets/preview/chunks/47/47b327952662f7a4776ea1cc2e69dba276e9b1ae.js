  ...
  return {
    ...
    execute: function () {
      ...
      _export("sgj_btn", sgj_btn = (_dec = ccclass('sgj_btn'), _dec2 = property({
        ...
        _onTouchStart(event) {
          console.log('bbbbbbbbbb'); // 第一次触摸立即回调一次
        ...
        handleToucheLogic(touchCounter, customEventData) {
          console.log("\u754C\u9762\u5C31\u4E0D\u6F14\u793A\u8F93\u51FA CustomEventData\u4E86 - ", customEventData); // console.log(customEventData);
        }
...
//# sourceMappingURL=47b327952662f7a4776ea1cc2e69dba276e9b1ae.js.map