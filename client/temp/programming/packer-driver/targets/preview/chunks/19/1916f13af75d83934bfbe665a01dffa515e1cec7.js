    ...
    execute: function () {
      ...
      _export("game_sgj", game_sgj = (_dec = ccclass('game_sgj'), _dec(_class = class game_sgj extends Component {
        constructor() {
          ...
          this.serverStep = [1, 3, 17, 7, 0, 10, 2, 4, 14, 8, 0, 11, 1, 3, 16, 6, 0, 12, 2, 5, 15, 8, 0, 13];
        }
        ...
        getServerData() {
          //获取随机中奖格子
          var t_step = randomRangeInt(1, 25);
          this.cmd_s_gameEnd.step = t_step; //倍数

          var bs = randomRangeInt(0, 8);
          this.cmd_s_gameEnd.tiems = this.times[bs]; //获取玩家下注总和
          ...
          var t_area = this.serverStep[t_step];
          if (t_area > 9) t_area = t_area - 10;
          this.cmd_s_gameEnd.area = t_area; //判断玩家是否中奖
...
//# sourceMappingURL=1916f13af75d83934bfbe665a01dffa515e1cec7.js.map