  ...
  return {
    ...
    execute: function () {
      ...
      _export("sgj_run", sgj_run = (_dec = ccclass('sgj_run'), _dec(_class = class sgj_run extends Component {
        ...
        updateMask() {
          //中奖结束回调
          var curIndex = Math.floor(this.startIndex) % 24; //console.log('当前格子 = ', curIndex);
          ...
          if (this.startIndex >= 14 && this.startIndex < this.endIndex - 13 && this.sound2_time > 1) {
            this.sound2_time = 0;
            (_crd && AudioMgr === void 0 ? (_reportPossibleCrUseOfAudioMgr({
              error: Error()
            }), AudioMgr) : AudioMgr).inst.playOneShot('sound/sgj/turnstep2');
          } else {
            this.sound2_time = this.sound2_time + 0.8;
          } //音频控制3


          if (this.startIndex >= this.endIndex - 13 && this.sound3_time == false) {
...
//# sourceMappingURL=4d060efe14278ce5976d816318b2b648948ad9bc.js.map