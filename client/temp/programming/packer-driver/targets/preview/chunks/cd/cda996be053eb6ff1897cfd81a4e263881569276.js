  ...
  return {
    ...
    execute: function () {
      ...
      _export("hall", hall = (_dec = ccclass('hall'), _dec2 = property(Node), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec(_class = (_class2 = class hall extends Component {
        ...
        onEnable() {
          globalThis.eventTargets.on('nickname', this.addTops, this);
        }

        onDisable() {
          globalThis.eventTargets.off('nickname', this.addTops, this);
        }
...
//# sourceMappingURL=cda996be053eb6ff1897cfd81a4e263881569276.js.map