  ...
  return {
    ...
    execute: function () {
      ...
      _export("sgj_run", sgj_run = (_dec = ccclass('sgj_run'), _dec(_class = class sgj_run extends Component {
        ...
        updateMask() {
          //中奖结束回调
          var curIndex = Math.floor(this.startIndex) % 24;
          ...
          if (this.startIndex < 14) {
            ...
            this.startIndex = this.startIndex + 0.5; //  AudioMgr.inst.playOneShot('sound/sgj/turnstep2');
          } else if (this.startIndex < this.endIndex && this.sound3_time == false) {
            this.startIndex = this.startIndex + 1;
            this.sound3_time = true; //  AudioMgr.inst.playOneShot('sound/sgj/turnstep3');
          } else {
            this.startIndex = this.startIndex + 0.5;
          } //音频控制2


          if (this.startIndex >= 14 && this.startIndex < this.endIndex - 9 && this.sound2_time > 1) {
            this.sound2_time = 0;
            (_crd && AudioMgr === void 0 ? (_reportPossibleCrUseOfAudioMgr({
              error: Error()
          ...
          if (this.startIndex >= this.endIndex - 9 && this.sound3_time == false) {
...
//# sourceMappingURL=ac6a30d538cf29fae3de9af2a56a80f52267c6ec.js.map