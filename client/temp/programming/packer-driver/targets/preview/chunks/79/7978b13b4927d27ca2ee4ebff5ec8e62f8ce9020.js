System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, EventTarget, HTTP, _dec, _class, _crd, ccclass, property, game_sgj;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'SpriteFrame', 'Sprite', 'resources', 'Prefab', 'instantiate', 'EventTarget']);
      ...
      _export("game_sgj", game_sgj = (_dec = ccclass('game_sgj'), _dec(_class = class game_sgj extends Component {
        ...
        start() {
          ...
          globalThis.sgj_normal.play(); // AudioMgr.inst.play('sound/sgj/C1')
        }
...
//# sourceMappingURL=7978b13b4927d27ca2ee4ebff5ec8e62f8ce9020.js.map