  ...
  return {
    ...
    execute: function () {
      ...
      _export("login", login = (_dec = ccclass('login'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = class login extends Component {
        ...
        addLoadingTips(arg1, arg2) {
          console.log(arg1, arg2);
          var t_script = this.loading_node.getComponent("loading");
          t_script.setTips(arg2);
          if (arg1 == 'show') this.loading_node.active = true;else if (arg1 == 'hide') this.loading_node.active = false;
        } //按钮事件
...
//# sourceMappingURL=5c839d4eeec2159e603bc3ec44e96c5c38f0196c.js.map