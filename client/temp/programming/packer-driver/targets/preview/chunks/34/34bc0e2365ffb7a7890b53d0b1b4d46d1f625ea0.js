        ...
        handleToucheLogic(touchCounter, customEventData) {
          ...
          switch (customEventData) {
            ...
            case 'go':
              {
                //判断当前状态
                if (globalThis.curgame.gameState == 0) //下注状态--开始游戏
                  {
                    globalThis.sgj_normal.stop();
                    var temp = globalThis.curgame.getServerData();
                    globalThis.sgj_run.play(temp.step);
                  } else if (globalThis.curgame.gameState == 1) //结束状态--可以收分
                  {
...
//# sourceMappingURL=34bc0e2365ffb7a7890b53d0b1b4d46d1f625ea0.js.map