      ...
      _export("userMgr", userMgr = (_dec = ccclass('userMgr'), _dec(_class = (_class2 = class userMgr extends Component {
        ...
        onGuest(data) {
          if (data.userid == 0) {
            ...
            console.log('serverMap ===', globalThis.userMgr.serverMap[0]); // globalThis.userMgr.hallip = data.hallip;
...
//# sourceMappingURL=f656a30f12484e31bda52ea0bd68eab78ec396ed.js.map