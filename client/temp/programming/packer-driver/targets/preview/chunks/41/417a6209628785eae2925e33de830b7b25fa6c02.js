System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, EventTarget, userMgr, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, eventTarget, login;
  ...
  return {
    ...
    execute: function () {
      ...
      globalThis.eventTargets = eventTarget;
      ...
      _export("login", login = (_dec = ccclass('login'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class login extends Component {
        ...
        start() {// globalThis.eventTarget.on('nickname', function (data) {
          //     console.log(data);
          // })
        }
...
//# sourceMappingURL=417a6209628785eae2925e33de830b7b25fa6c02.js.map