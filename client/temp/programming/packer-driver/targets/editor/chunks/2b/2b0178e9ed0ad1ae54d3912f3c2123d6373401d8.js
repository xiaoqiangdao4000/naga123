System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Sprite, Quat, Vec3, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, loading;
    ...
    execute: function () {
      ...
      _export("loading", loading = (_dec = ccclass('loading'), _dec2 = property(Sprite), _dec(_class = (_class2 = class loading extends Component {
        ...
        start() {
          ...
          var r = new Quat(sprnode.getRotation().x + 1, sprnode.getRotation().y, sprnode.getRotation().z, sprnode.getRotation().w);
          sprnode.setRotationFromEuler(new Vec3(0, 90, 0)); // tween(sprnode)
          // .by(1, { rotaton(): r })
          // .repeatForever()
          // .start()
        }
...
//# sourceMappingURL=2b0178e9ed0ad1ae54d3912f3c2123d6373401d8.js.map