      ...
      _export("login", login = (_dec = ccclass('login'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class login extends Component {
        ...
        onBtnClick(event, customEventData) {
          switch (customEventData) {
            case 'guestLogin':
              {
                let userinfo = globalThis.userMgr.getAccount(); //globalThis.login_message.sendMssage('guestLogin', account);
                ...
                console.log('发送游客登录请求login = ', userinfo);
                break;
              }
...
//# sourceMappingURL=b4dc1bdef206e9caf0dd86d1282b80c19512b187.js.map