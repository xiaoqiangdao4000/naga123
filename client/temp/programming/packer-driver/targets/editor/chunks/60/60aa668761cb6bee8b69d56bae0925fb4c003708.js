    ...
    execute: function () {
      ...
      _export("loading", loading = (_dec = ccclass('loading'), _dec2 = property(Sprite), _dec(_class = (_class2 = class loading extends Component {
        ...
        start() {
          ...
          var r = new Quat(sprnode.getRotation().x, sprnode.getRotation().y + 0.2, sprnode.getRotation().z, sprnode.getRotation().w);
          tween(sprnode).by(1, {
            rotation: r
          }).repeatForever().start();
        }
...
//# sourceMappingURL=60aa668761cb6bee8b69d56bae0925fb4c003708.js.map