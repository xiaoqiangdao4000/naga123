      ...
      _export("sgj_sprite", sgj_sprite = (_dec = ccclass('sgj_sprite'), _dec2 = property(SpriteFrame), _dec3 = property(SpriteFrame), _dec4 = property(Sprite), _dec5 = property(Sprite), _dec6 = property(Node), _dec(_class = (_class2 = (_class3 = class sgj_sprite extends Component {
        ...
        setUserScore(score) {
          ...
          for (let i = 0; i < 10; i++) {
            if (i < len) {
              let st = Number(str[len - i - 1]);
              sgj_sprite.getInstance().user_score_spr[i].spriteFrame = sgj_sprite.getInstance().up_number_spf[st];
              sgj_sprite.getInstance().user_score_spr[i].node.active = true;
            } else {
              sgj_sprite.getInstance().user_score_spr[i].node.active = false;
            }
          }
        } //arg1:弹窗内容
...
//# sourceMappingURL=5beb5b116ad2b9264f7e03ed50bd2999e220b34b.js.map