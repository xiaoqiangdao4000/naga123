System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Prefab, EventTarget, Label, instantiate, resources, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, hall;
    ...
    execute: function () {
      ...
      _export("hall", hall = (_dec = ccclass('hall'), _dec2 = property(Node), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Node), _dec(_class = (_class2 = class hall extends Component {
        ...
        onEnable() {
          ...
          globalThis.eventTargets.on('hall_updateUserInfo', this.updateUserInfo, this);
        }

        onDisable() {
          globalThis.eventTargets.off('hall_popTips', this.addTops, this);
          globalThis.eventTargets.off('hall_updateUserInfo', this.updateUserInfo, this);
        } //arg1:弹窗内容
        ...
        updateUserInfo(arg1, arg2, arg3, arg4) {
          this.userid_lb.string = arg1;
          this.nickname_lb.string = arg2;
        }
...
//# sourceMappingURL=92d3d0f9e891b002e8a549b0521890dd8b5a1e18.js.map