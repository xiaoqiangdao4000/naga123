System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Label, director, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, eventTarget, hall;
  ...
  return {
    ...
    execute: function () {
      ...
      console.log('new eventTarget = ', eventTarget);
      ...
      _export("hall", hall = (_dec = ccclass('hall'), _dec2 = property(Node), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec(_class = (_class2 = class hall extends Component {
        ...
        init() {
          ...
          globalThis.eventTarget.on('nickname', function (event) {
            console.log(event);
          }.bind(this));
...
//# sourceMappingURL=3d342d47f643d366e1dd678cdf1f1b407c165119.js.map