  ...
  return {
    ...
    execute: function () {
      ...
      _export("game_sgj", game_sgj = (_dec = ccclass('game_sgj'), _dec(_class = class game_sgj extends Component {
        ...
        getServerData() {
          //获取随机--中奖格子
          let t_step = randomRangeInt(1, 25); //倍数

          let bs = randomRangeInt(0, 8); //获取玩家下注总和
          ...
          let winscore = 0; //lucky：2-灭灯，3-翻倍，4-大三元，5-小三元，6-大四喜，7-众横四海，8-仙女散花，9-天龙八部，10-九莲宝灯，11-大满贯
          ...
          if (t_area == 8) //中lucky、随机1到99倍、送灯
            ...
            } else if (globalThis.sgj_view.bet_score[t_area] > 0) //普通中奖 下注*倍数
            {
              ...
              console.log('aaaaaa = ', this.cmd_s_gameEnd);
            } else //不中奖
            {
              winscore = 0;
...
//# sourceMappingURL=3e7c374d70f0ca8d5b3f9652c7e5b6ef90b0feb4.js.map