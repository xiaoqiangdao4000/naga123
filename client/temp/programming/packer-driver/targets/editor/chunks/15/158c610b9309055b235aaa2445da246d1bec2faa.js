    ...
    execute: function () {
      ...
      _export("sgj_btn", sgj_btn = (_dec = ccclass('sgj_btn'), _dec2 = property({
        ...
        addAllBetOneScore() {
          ...
          if (t_game_sgj.bet_score[0] >= 99 && t_game_sgj.bet_score[1] >= 99 && t_game_sgj.bet_score[2] >= 99 && t_game_sgj.bet_score[3] >= 99 && t_game_sgj.bet_score[4] >= 99 && t_game_sgj.bet_score[5] >= 99 && t_game_sgj.bet_score[6] >= 99 && t_game_sgj.bet_score[7] >= 99) {
            globalThis.sgj_view.addTops('已经是最大下注了，请点击开始游戏！');
            return;
          }

          t_game_sgj.addBetOneScore(0, false);
          t_game_sgj.addBetOneScore(1, false);
          t_game_sgj.addBetOneScore(2, false);
          t_game_sgj.addBetOneScore(3, false);
          t_game_sgj.addBetOneScore(4, false);
          t_game_sgj.addBetOneScore(5, false);
          t_game_sgj.addBetOneScore(6, false);
          t_game_sgj.addBetOneScore(7, false);
        } //下注+1


        addBetOneScore(area, showtips = true) {
          if (area < 0 || area > 7) return;
          let t_game_sgj = globalThis.game_sgj;

          if (globalThis.userMgr.score > 0 && t_game_sgj.bet_score[area] < 100) {
            t_game_sgj.bet_score[area] += 1;
            globalThis.userMgr.score -= 1; //刷新下注、用户分数

            t_game_sgj.setBetScore(area, t_game_sgj.bet_score[area]);
            t_game_sgj.setUserScore(globalThis.userMgr.score); //开启go按钮
...
//# sourceMappingURL=158c610b9309055b235aaa2445da246d1bec2faa.js.map