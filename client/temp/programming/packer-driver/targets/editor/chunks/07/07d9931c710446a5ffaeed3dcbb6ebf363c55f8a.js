  ...
  return {
    ...
    execute: function () {
      ...
      _export("login", login = (_dec = ccclass('login'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = class login extends Component {
        ...
        addLoadingTips(type, tipsText, deltaTime = 0) {
          console.log(type, tipsText);
          let t_script = this.loading_node.getComponent("loading");
          t_script.setTips(tipsText, deltaTime);
        } //按钮事件
...
//# sourceMappingURL=07d9931c710446a5ffaeed3dcbb6ebf363c55f8a.js.map