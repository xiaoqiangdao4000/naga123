System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, director, HTTP, _dec, _class, _crd, ccclass, property, login_message;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("login_message", login_message = (_dec = ccclass('login_message'), _dec(_class = class login_message extends Component {
        ...
        update(deltaTime) {} // connectServer() {
        ...
        sendMssage(type, data) {
          ...
          (_crd && HTTP === void 0 ? (_reportPossibleCrUseOfHTTP({
            error: Error()
          }), HTTP) : HTTP).getInstance().sendRequest(); // this._ws.send(JSON.stringify(msg));
        }
...
//# sourceMappingURL=656f5cc9f5326b3dab36cf25725016076bd097f8.js.map