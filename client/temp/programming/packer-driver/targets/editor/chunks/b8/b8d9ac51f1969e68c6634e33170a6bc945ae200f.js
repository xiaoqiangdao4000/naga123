      ...
      _export("userMgr", userMgr = (_dec = ccclass('userMgr'), _dec(_class = (_class2 = class userMgr extends Component {
        ...
        onGuest(data) {
          if (data.userid == 0) {
            ...
            globalThis.userMgr.serverMap = data.serverMap;
            console.log('serverMap ===', data.serverMap); // globalThis.userMgr.hallip = data.hallip;
...
//# sourceMappingURL=b8d9ac51f1969e68c6634e33170a6bc945ae200f.js.map