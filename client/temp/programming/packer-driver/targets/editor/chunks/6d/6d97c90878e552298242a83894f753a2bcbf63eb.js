  ...
  return {
    ...
    execute: function () {
      ...
      _export("loading", loading = (_dec = ccclass('loading'), _dec2 = property(Sprite), _dec(_class = (_class2 = class loading extends Component {
        ...
        start() {
          console.log('开始旋转！');
          var r = new Quat(this.node.getRotation().x + 10, this.node.getRotation().y + 1, this.node.getRotation().z + 1, this.node.getRotation().w);
...
//# sourceMappingURL=6d97c90878e552298242a83894f753a2bcbf63eb.js.map