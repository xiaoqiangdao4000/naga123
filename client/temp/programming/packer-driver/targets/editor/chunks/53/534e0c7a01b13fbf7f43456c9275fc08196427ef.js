    ...
    execute: function () {
      ...
      _export("tips", tips = (_dec = ccclass('tips'), _dec2 = property(Label), _dec3 = property(Sprite), _dec(_class = (_class2 = class tips extends Component {
        ...
        onShow(text) {
          ...
          let color_move_to = tween(this.tips_sprite).to(tweenDuration, {
            color: color(0, 0, 0, 0)
          });
          tween(this.node).to(1.0, {
            position: new Vec3(0, 255, 0)
          }).start();
          tween(this.tips_sprite).to(tweenDuration, {
            color: color(0, 0, 0, 0)
          }).start(); // tween(this.node)
          //     .to(1.0, { position: new Vec3(0, 255, 0) })
          //     // to 动作完成后会调用该方法     
          //     .removeSelf()
          //     .start()
        }
...
//# sourceMappingURL=534e0c7a01b13fbf7f43456c9275fc08196427ef.js.map