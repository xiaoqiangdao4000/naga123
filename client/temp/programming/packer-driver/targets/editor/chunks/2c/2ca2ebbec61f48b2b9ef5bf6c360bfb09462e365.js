  ...
  return {
    ...
    execute: function () {
      ...
      _export("hall", hall = (_dec = ccclass('hall'), _dec2 = property(Node), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec(_class = (_class2 = class hall extends Component {
        ...
        onEnable() {
          globalThis.eventTarget.on('nickname', this._sayHello, this);
        }

        onDisable() {
          globalThis.eventTarget.off('nickname', this._sayHello, this);
        }
...
//# sourceMappingURL=2ca2ebbec61f48b2b9ef5bf6c360bfb09462e365.js.map