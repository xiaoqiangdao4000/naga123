  ...
  return {
    ...
    execute: function () {
      ...
      _export("loading", loading = (_dec = ccclass('loading'), _dec2 = property(Sprite), _dec(_class = (_class2 = class loading extends Component {
        ...
        start() {
          var r = new Quat(this.node.getRotation().x + 10, this.node.getRotation().y, this.node.getRotation().z, this.node.getRotation().w);
...
//# sourceMappingURL=d9f85e926d52a99429ffe6993d5324db67b020a3.js.map