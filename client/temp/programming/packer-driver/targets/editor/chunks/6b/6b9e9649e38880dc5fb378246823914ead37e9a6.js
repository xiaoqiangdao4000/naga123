  ...
  return {
    ...
    execute: function () {
      ...
      _export("loading", loading = (_dec = ccclass('loading'), _dec2 = property(Sprite), _dec(_class = (_class2 = class loading extends Component {
        ...
        start() {
          console.log('开始旋转！');
          var r = new Quat(this.node.getRotation().x, this.node.getRotation().y + 0.2, this.node.getRotation().z, this.node.getRotation().w);
          tween(this.loading_spr.node).by(1, {
            rotation: r
          }).repeatForever().start();
        }
...
//# sourceMappingURL=6b9e9649e38880dc5fb378246823914ead37e9a6.js.map