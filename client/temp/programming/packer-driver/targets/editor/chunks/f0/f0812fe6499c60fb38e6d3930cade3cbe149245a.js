  ...
  return {
    ...
    execute: function () {
      ...
      _export("login_account", login_account = (_dec = ccclass('login_account'), _dec2 = property(EditBox), _dec3 = property(EditBox), _dec(_class = (_class2 = class login_account extends Component {
        ...
        start() {
          console.log('脚本激活2：login_account');
        ...
        onEnable() {
          console.log('脚本激活1：login_account');
        }

        onDisable() {
          console.log('脚本激活3：login_account');
        }
...
//# sourceMappingURL=f0812fe6499c60fb38e6d3930cade3cbe149245a.js.map