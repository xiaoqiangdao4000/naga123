  ...
  return {
    ...
    execute: function () {
      ...
      _export("loading", loading = (_dec = ccclass('loading'), _dec2 = property(Sprite), _dec(_class = (_class2 = class loading extends Component {
        ...
        start() {
          console.log('开始旋转！');
          var r = new Quat(this.node.getRotation().x + 10, this.node.getRotation().y + 1, this.node.getRotation().z, this.node.getRotation().w);
...
//# sourceMappingURL=68ef5bfdbd7ced9c765538668fb481581d1bc4f9.js.map