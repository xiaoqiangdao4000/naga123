        ...
        updateMask() {
          ...
          if (this.startIndex > 14 && this.startIndex < this.endIndex - 16 && this.sound2_time > 1) {
            ...
            if ((_crd && AudioMgr === void 0 ? (_reportPossibleCrUseOfAudioMgr({
              ...
              console.log('正在播放中111。。。。 = ', (_crd && AudioMgr === void 0 ? (_reportPossibleCrUseOfAudioMgr({
                error: Error()
              }), AudioMgr) : AudioMgr).inst.isPlaying());
              (_crd && AudioMgr === void 0 ? (_reportPossibleCrUseOfAudioMgr({
                error: Error()
              }), AudioMgr) : AudioMgr).inst.playOneShot('sound/sgj/turnstep2');
              console.log('正在播放中222。。。。 = ', (_crd && AudioMgr === void 0 ? (_reportPossibleCrUseOfAudioMgr({
                error: Error()
              }), AudioMgr) : AudioMgr).inst.isPlaying());
            }
          } else {
...
//# sourceMappingURL=c9a5818677ccaaa505d8c97ca2c642046cec75a2.js.map