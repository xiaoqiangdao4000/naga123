  ...
  return {
    ...
    execute: function () {
      ...
      _export("hall", hall = (_dec = ccclass('hall'), _dec2 = property(Node), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec(_class = (_class2 = class hall extends Component {
        ...
        onEnable() {
          globalThis.eventTargets.on('chick_nickname', this.addTops, this);
          globalThis.eventTargets.on('chick_password', this.addTops, this);
        }

        onDisable() {
          globalThis.eventTargets.off('chick_nickname', this.addTops, this);
          globalThis.eventTargets.on('chick_password', this.addTops, this);
        }
...
//# sourceMappingURL=e9d91959c98ccddb97d09ddf2b35968ad592e920.js.map